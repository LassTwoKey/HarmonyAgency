(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".our-team__swiper")) new core(".our-team__swiper", {
            modules: [ Navigation ],
            observer: true,
            loop: true,
            observeParents: true,
        ...
        if (document.querySelector(".what-say__swiper")) new core(".what-say__swiper", {
            modules: [ Pagination ],
            observer: true,
            loop: true,
            observeParents: true,
        ...
        if (document.querySelector(".brands__swider")) new core(".brands__swider", {
            modules: [ Navigation ],
            observer: true,
            loop: true,
            observeParents: true,
    ...
    const filterBox = document.querySelectorAll(".recent-work__item");
    if (document.querySelector(".recent-work__body") && filterBox) document.querySelector(".recent-work__body").addEventListener("click", (function(e) {
        if ("LI" !== e.target.tagName) return false;
